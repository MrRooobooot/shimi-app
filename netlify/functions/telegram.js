...
const ROASTS = [
  {
    triggers: ["خسته", "خستم", "بسه", "نمیکشم", "نابودم", "بریدم", "خسته ام", "خسته شدم"],
    emoji: "🥱",
    replies: [
  ...
  {
    triggers: ["حوصله ندارم", "فردا میخونم", "فردا می‌خونم", "حال ندارم", "ولش", "بیخیال", "حوصله"],
    emoji: "🤡",
    replies: [
  ...
  {
    triggers: ["ربات", "هرمس", "بات", "احمق", "خنگ", "گاوی", "بیشعور", "نفهم", "خر", "الاغ"],
    emoji: "🗿",
    replies: [
  ...
  {
    triggers: ["الهه", "خانم محمددوست", "دکتر", "استاد"],
    emoji: "💅",
    replies: [
      "خانم دکتر سر کلاسه داره رتبه ۷۸۸ رو پز میده، منم دستیار بداخلاقشم! چی کار داری باز؟",
      "اسم دکتر رو الکی به زبون نیار، اول پلنر هفتگی رو پر کن بعد اجازه داری اسمشو ببری!",
      "رتبه ۷۸۸ به کسی برنمی‌خوره عزیزم، مگه اینکه تو تست‌های pH رو خراب کنی که اونوقت خانم دکتر دستور حذف تو رو صادر می‌کنه!"
    ]
  },
  {
    triggers: ["آیدین", "مهندس"],
    emoji: "👨‍💻",
    replies: [
  ...
  {
    triggers: ["کنکور", "رتبه", "پزشکی", "دندان", "دارو", "قم"],
    emoji: "💀",
    replies: [
      ...
      "می‌خوای دکتر بشی؟ اول باید قید خواب، گشت‌وگذار و تلگرام رو بزنی بعد بیا اونجا حرف بزنیم گوزن!",
      "داروسازی؟ بهتره اول بری داروی ضد پا‌خواب‌نشینی بخر که تو کلاس سر جلسه خواب نری!"
    ]
  },
  {
    triggers: ["عشقی", "دوستت دارم", "قربونت", "فدات", "نوکرم", "چاکرم", "به قربونت"],
    emoji: "🤮",
    replies: [
  ...
  {
    triggers: ["شیمی", "سخته", "نمیفهمم", "گنگه", "سخت", "نمیدونم"],
    emoji: "🤯",
    replies: [
  ...
  {
    triggers: ["پول", "تخفیف", "گرونه", "شهریه", "مفتی", "رایگان"],
    emoji: "💸",
    replies: [
      ...
      "قیمت مشاوره از یه گوشی نوک比亚 گوشی‌ت کمتره! اگر این‌قدر نگران آینده‌ای، برو دنبال یه شغل باحقوق ثابت و عقب افتاده از دنیا!"
    ]
  },
  {
    triggers: ["سلام", "درود", "سلام دوستان", "سلام ربات", "بای", "خداحافظ"],
    emoji: "🫡",
    replies: [
      "سلام بی‌مغز! به جای ۱۰ دقیقه سلام و علیک، برو ۱۰ تست استوکیومتری بزن که دم جمعه نکنی!",
      "درود بر تو، به شرطی که بری تست بزنی! وگرنه سلام‌ت هم حرام بر من و رتبه ۷۸۸ است.",
      "بای‌بای! برو خدا حافظ، وقتی برگشتی ببینم چند درصد پیشرفت کردی، وگرنه اخم می‌کنم بهت!"
    ]
  },
  {
    triggers: ["مینی اپ", "مینی‌اپ", "اپلیکیشن", "وب‌اپ", "وب اپ"],
    emoji: "📱",
    replies: [
  ...
  {
    triggers: ["آزمون", "امتحان", "آزمایشی", "کارنامه", "تراز"],
    emoji: "📝",
    replies: [
      "ترازت رو دیدم، رفتم خوابیدم! تو هم برو بخواب، کاری به کارت ندارم دیگه.",
      "تو آزمون آزمایشی شرکت کردی یا رفتی و فوت کردی برگه رو؟ ببین من جوابمو باید از یه برگه سفید بگیرم؟"
    ]
  }
];

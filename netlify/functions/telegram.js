...
const ROASTS = [
  ...
  {
    triggers: ["ربات", "هرمس", "بات", "احمق", "خنگ", "گاوی", "بیشعور", "نفهم"],
    emoji: "🗿",
    replies: [
  ...
  {
    triggers: ["الهه", "خانم محمددوست", "دکتر"],
    emoji: "💅",
    replies: [
  ...
  {
    triggers: ["کنکور", "رتبه", "پزشکی", "دندان", "دارو"],
    emoji: "💀",
    replies: [
  ...
  {
    triggers: ["عشقی", "دوستت دارم", "قربونت", "فدات", "نوکرم", "چاکرم"],
    emoji: "🤮",
    replies: [
  ...
  {
    triggers: ["شیمی", "سخته", "نمیفهمم", "گنگه"],
    emoji: "🤯",
    replies: [
  ...
  {
    triggers: ["پول", "تخفیف", "گرونه", "شهریه", "مفتی"],
    emoji: "💸",
    replies: [
    ...
    if (update.message) {
      ...
      for (const r of ROASTS) {
        if (r.triggers.some(tr => lowText.includes(tr))) {
          ...
          const rep = r.replies[Math.floor(Math.random() * r.replies.length)];
